...
export interface PausedSequenceInfo {
    metaStepId: string;
    sequenceSteps: string[];
    pausedAtIndex: number; // Index of the step that just finished and caused the pause
    originalInputResourceIds: string[];
    baseNameToMatch: string | null; // Base name determined when the sequence paused
    // Store IDs generated by the step that paused, might be needed directly by the resuming step
    generatedResourceIdsBeforePause: string[];
}